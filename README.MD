...
3. **Backend validates credentials**
   ...
   - If valid, generates a JWT token with 7 days expiration and for every 15mins refreshed 
...
Backend validates username & password
      ↓
Backend generates JWT token ( refreshed for every 15mins and long lived for 7 days )
      ↓
